...
import com.besenior.kotlinadvancedcourse.hilt.module.AppModule_ProvideDatabaseFactory;
...
import com.besenior.kotlinadvancedcourse.viewmodel.AppViewModel_HiltModules_KeyModule_ProvideFactory;
...
public final class DaggerHiltApplication_HiltComponents_SingletonC extends HiltApplication_HiltComponents.SingletonC {
  ...
  private AppDatabase appDatabase() {
    return AppModule_ProvideDatabaseFactory.provideDatabase(ApplicationContextModule_ProvideApplicationFactory.provideApplication(applicationContextModule));
  }

  @SuppressWarnings("unchecked")
  private void initialize(final ApplicationContextModule applicationContextModuleParam) {
    this.provideDatabaseProvider = DoubleCheck.provider(new SwitchingProvider<AppDatabase>(singletonC, 0));
  }
  ...
  private static final class FragmentCImpl extends HiltApplication_HiltComponents.FragmentC {
    ...
    @Override
    public void injectSingleNoteFragment(SingleNoteFragment singleNoteFragment) {
    }
  ...
  private static final class ActivityCImpl extends HiltApplication_HiltComponents.ActivityC {
    ...
    public Set<String> getViewModelKeys() {
      return Collections.<String>singleton(AppViewModel_HiltModules_KeyModule_ProvideFactory.provide());
    }
  ...
  private static final class ViewModelCImpl extends HiltApplication_HiltComponents.ViewModelC {
    ...
    private AppRepository appRepository() {
      return new AppRepository(singletonC.provideDatabaseProvider.get());
    }
    ...
    private void initialize(final SavedStateHandle savedStateHandleParam) {
      this.appViewModelProvider = new SwitchingProvider<>(singletonC, activityRetainedCImpl, viewModelCImpl, 0);
    }

    @Override
    public Map<String, Provider<ViewModel>> getHiltViewModelMap() {
      return Collections.<String, Provider<ViewModel>>singletonMap("com.besenior.kotlinadvancedcourse.viewmodel.AppViewModel", (Provider) appViewModelProvider);
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          case 0: // com.besenior.kotlinadvancedcourse.viewmodel.AppViewModel 
          return (T) viewModelCImpl.appViewModel();
  ...
  private static final class SwitchingProvider<T> implements Provider<T> {
    ...
    public T get() {
      switch (id) {
        case 0: // com.besenior.kotlinadvancedcourse.room.AppDatabase 
