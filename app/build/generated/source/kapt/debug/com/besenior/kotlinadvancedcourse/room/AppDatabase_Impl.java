  ...
  protected SupportSQLiteOpenHelper createOpenHelper(DatabaseConfiguration configuration) {
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(configuration, new RoomOpenHelper.Delegate(1) {
      ...
      public void createAllTables(SupportSQLiteDatabase _db) {
        _db.execSQL("CREATE TABLE IF NOT EXISTS `notetable` (`uid` INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, `notesModel` TEXT NOT NULL)");
        _db.execSQL("CREATE TABLE IF NOT EXISTS room_master_table (id INTEGER PRIMARY KEY,identity_hash TEXT)");
        _db.execSQL("INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, '34dcfd1481eed0dfb35c5962908baff7')");
      }
      ...
      protected RoomOpenHelper.ValidationResult onValidateSchema(SupportSQLiteDatabase _db) {
        ...
        _columnsNotetable.put("uid", new TableInfo.Column("uid", "INTEGER", true, 1, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsNotetable.put("notesModel", new TableInfo.Column("notesModel", "TEXT", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        ...
        if (! _infoNotetable.equals(_existingNotetable)) {
          return new RoomOpenHelper.ValidationResult(false, "notetable(com.besenior.kotlinadvancedcourse.room.entities.NoteEntity).\n"
                  + " Expected:\n" + _infoNotetable + "\n"
                  + " Found:\n" + _existingNotetable);
        }
        return new RoomOpenHelper.ValidationResult(true, null);
      }
    }, "34dcfd1481eed0dfb35c5962908baff7", "ecf1969155e0f8bb1ef0eef5a7d15bec");
