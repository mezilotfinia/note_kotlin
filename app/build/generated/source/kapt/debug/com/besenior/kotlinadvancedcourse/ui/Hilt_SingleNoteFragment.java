...
public abstract class Hilt_SingleNoteFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_SingleNoteFragment() {
    super();
  }

  Hilt_SingleNoteFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((SingleNoteFragment_GeneratedInjector) this.generatedComponent()).injectSingleNoteFragment(UnsafeCasts.<SingleNoteFragment>unsafeCast(this));
    }
  }
